 ...
 */
public class RefreshiOS implements Refreshble {
    private static final String TAG ="RefreshiOS" ;
    private Callable callable;
    private SwipeRefreshLayout swipeRefreshLayout;
    public RefreshiOS(Callable callable,SwipeRefreshLayout swipeRefreshLayout) {
        this.swipeRefreshLayout = swipeRefreshLayout;
        this.callable = callable;
    }
    @Override
    public void refresh() {
        NetorkGetDataUtils.iOSModels.clear();
        NetorkGetDataUtils.iOSCurrentPage = 1;
